...
By looking in the package.json you can see that the project already has mocha installed as a dependency. To get the package run `npm install` in the same directory as the package.json, which generates the node_modules.
