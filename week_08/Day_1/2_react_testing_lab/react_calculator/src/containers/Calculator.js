    ...
    if (previousOperator) {
      switch (previousOperator) {
        ...
        case '/':
          ...
          break;
        default:
          // If the previous operator was not one of the expected values,
          // throw an error to indicate an invalid operator
          throw new Error(`Invalid operator: ${previousOperator}`);
      }
    }
