...
const About = () => {
  return (
    <>
      ...
      <h3>FilteredSearch - staticData</h3>
      <p>This is a basic filtered search with show hide for data list</p>

      <h3>FilteredSearchDB - localDB</h3>
      <p>This is a basic filtered search connecting to localDB for data list</p>
      <h3>StockChart - localDB</h3>
      <p>
        This is a dropdown option to choose a single company - currently using
        static array of names and symbols
      </p>
      <h3>StockChartAll - AlphAPI</h3>
      <p>
